...
const translationMap: Record<Language, Translations> = {
  en: {
    ...
    'chat.header.vanessaSubtitle': 'AI companion with clinical analysis and voice support',
    'chat.header.monicaSubtitle': 'AI companion with clinical analysis and voice support',
    'chat.header.warning': 'Voice features not available in this browser. You can still chat by typing.',
    ...
    'appointments.subheader': 'Book a video or audio session with your therapist',
    ...
    'appointments.noConnectionsDesc': 'You need to connect with a therapist before scheduling appointments.',
    'appointments.connectCta': 'Click here to connect with a therapist',
    'appointments.connectHow': 'How it works: Go to "Contact Therapist", submit your therapist\'s email, and wait for them to accept your connection request.',
    ...
    'appointments.notesPlaceholder': 'Any specific topics or concerns you’d like to discuss...',
    'appointments.important': 'Important Information',
    'appointments.info.internet': 'Both you and your therapist need internet connection',
    'appointments.info.recording': 'Sessions may be recorded for quality; we are working toward HIPAA readiness',
    'appointments.info.reminder': "You'll receive a reminder 1 hour before your appointment",
    'appointments.info.early': 'Please join 5 minutes early to test your connection',
    ...
    'appointments.scheduledDesc': 'Your appointment has been scheduled successfully',
    'appointments.failedTitle': 'Scheduling Failed',
    'appointments.failedDesc': 'Unable to schedule appointment. Please try again.',
    ...
    'appointments.inPersonInfo': 'This appointment is scheduled for an in-person visit. Arrive a few minutes early and bring your recording kit if required.',
    ...
    'appointments.noPastDesc': 'Past appointments will appear here after you attend or complete them.',
    'appointments.joinWindow': 'You can join 10 minutes before your scheduled time.',
    ...
    'appointments.noLinkYet': 'Your therapist will share the meeting link before the session, or you can join through Tranquiloo below.',
    ...
    'treatment.insights.noData': 'Collect more data over time to see treatment effectiveness patterns.',
    'treatment.insights.weeksImproved': '{improved} of {total} weeks showed improvement',
    'treatment.insights.decliningResults': 'Treatment is showing {status} results with an average anxiety level of {anxiety}/10',
    // Track outcomes/treatment page
    'treatmentResources.title': 'Track Outcomes & Treatment',
    'treatmentResources.subtitle': 'Monitor your progress, track goals, and access evidence-based treatments',
    ...
    'treatmentResources.noActiveDesc': 'Based on your anxiety patterns, we recommend starting with professional therapy',
    ...
    'treatmentResources.goalsSubtitle': 'Track your progress toward better mental health',
  ...
  es: {
    ...
    'chat.header.vanessaSubtitle': 'Compañera IA con análisis clínico y soporte de voz',
    'chat.header.monicaSubtitle': 'Compañera IA con análisis clínico y soporte de voz',
    'chat.header.warning': 'Las funciones de voz no están disponibles en este navegador. Aún puedes chatear escribiendo.',
    ...
    'appointments.subheader': 'Agenda una sesión de video o audio con tu terapeuta',
    ...
    'appointments.noConnectionsDesc': 'Debes conectar con un terapeuta antes de agendar citas.',
    'appointments.connectCta': 'Haz clic aquí para conectar con un terapeuta',
    'appointments.connectHow': 'Cómo funciona: Ve a "Contactar terapeuta", envía el correo de tu terapeuta y espera a que acepte la conexión.',
    ...
    'appointments.notesPlaceholder': 'Temas o preocupaciones que deseas tratar...',
    'appointments.important': 'Información importante',
    'appointments.info.internet': 'Tú y tu terapeuta necesitan conexión a internet',
    'appointments.info.recording': 'Las sesiones pueden grabarse para calidad; estamos trabajando hacia cumplimiento HIPAA',
    'appointments.info.reminder': 'Recibirás un recordatorio 1 hora antes de tu cita',
    ...
    'appointments.failedDesc': 'No se pudo agendar la cita. Intenta nuevamente.',
    ...
    'appointments.inPersonInfo': 'Esta cita es presencial. Llega unos minutos antes y lleva tu material si es necesario.',
    ...
    'appointments.noPastDesc': 'Tus citas pasadas aparecerán aquí después de asistir o completarlas.',
    'appointments.joinWindow': 'Puedes unirte 10 minutos antes de tu hora programada.',
    ...
    'appointments.minutesShort': 'min',
    'appointments.noLinkYet': 'Tu terapeuta compartirá el enlace antes de la sesión, o puedes unirte a través de Tranquiloo abajo.',
    ...
    'interventions.noTherapies': 'No se documentaron intervenciones en este periodo.',
    'interventions.clinicalNotes': 'Notas clínicas',
    'interventions.noNotes': 'No hay notas clínicas documentadas en este periodo.',
    'interventions.homework': 'Próximos pasos / tarea',
    'interventions.homeworkFallback': 'Continúa con el plan de afrontamiento acordado',
    ...
    'treatment.insights.noData': 'Reúne más datos con el tiempo para ver patrones de efectividad del tratamiento.',
    'treatment.insights.weeksImproved': '{improved} de {total} semanas mostraron mejora',
    'treatment.insights.decliningResults': 'El tratamiento muestra resultados {status} con un nivel de ansiedad promedio de {anxiety}/10',
    // Track outcomes/treatment page
    'treatmentResources.title': 'Seguimiento de resultados y tratamiento',
    'treatmentResources.subtitle': 'Monitorea tu progreso, registra metas y accede a tratamientos basados en evidencia',
    ...
    'treatmentResources.noActiveDesc': 'Según tus patrones de ansiedad, recomendamos iniciar con un terapeuta profesional',
    ...
    'treatmentResources.goalsSubtitle': 'Sigue tu progreso hacia una mejor salud mental',
    // Monthly session activity
