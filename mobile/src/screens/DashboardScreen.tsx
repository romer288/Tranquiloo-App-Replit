      ...
      <View style={styles.content}>
        ...
        <View style={styles.card}>
          ...
          <TouchableOpacity style={styles.actionButton}>
            <Text style={styles.actionButtonText}>📊 Anxiety Assessment</Text>
          </TouchableOpacity>
          ...
          <TouchableOpacity style={styles.actionButton}>
            <Text style={styles.actionButtonText}>🔍 Find Therapist</Text>
          </TouchableOpacity>
          
          <TouchableOpacity style={styles.actionButton}>
            <Text style={styles.actionButtonText}>📱 Crisis Support</Text>
          </TouchableOpacity>
        </View>
